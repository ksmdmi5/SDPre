...
// 1) The version without a function is much longer.
// 2) It would be much harder to fix the verion without functions due to the amount
//    of code that would need to be modified.
// 3) Not too much harder, just more code needs modified.
